...
// in both horizontal and vertical directions, based on image dimensions,
// room size, and room spacing.
// Returns (roomsX, roomsY) - the number of rooms from center to edge in each direction.
